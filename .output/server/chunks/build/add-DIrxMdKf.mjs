...
import { defineComponent, computed, ref, resolveComponent, mergeProps, unref, withCtx, createTextVNode, toDisplayString, isRef, createVNode, useSlots, renderSlot, openBlock, createBlock, createCommentVNode, Fragment, renderList, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrInterpolate, ssrRenderComponent, ssrRenderSlot, ssrRenderList, ssrRenderClass } from 'vue/server-renderer';
import { useForwardPropsEmits, TabsRoot, TabsList, TabsIndicator, TabsTrigger, TabsContent, Primitive } from 'reka-ui';
import { reactivePick } from '@vueuse/core';
import { h as useI18n, u as useHead, e as _sfc_main$d, i as _sfc_main$8, a as useAppConfig, b as useComponentUI, t as tv, g as get, f as _sfc_main$b, n as navigateTo, c as useFieldGroup, d as useComponentIcons } from './server.mjs';
import { _ as _sfc_main$4 } from './Input-Ce9v83s4.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "p-4" }, _attrs))}><div class="mb-6 bracket-lg px-4 py-3"><h1 class="text-2xl font-bold text-phosphor">${ssrInterpolate(unref(t)("add.title"))}</h1><p class="header-meta"> Add torrents via file upload, magnet link, or URL </p><span class="bl"></span><span class="br2"></span></div>`);
      if (unref(success)) {
            ...
            _push2(ssrRenderComponent(_component_UTab, { value: "file" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(` ${ssrInterpolate(unref(t)("add.file"))}`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_UTab, { value: "magnet" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(` ${ssrInterpolate(unref(t)("add.magnet"))}`);
                } else {
                  return [
                    createVNode(_component_UIcon, {
                      name: "i-heroicons-link",
            ...
            _push2(ssrRenderComponent(_component_UTab, { value: "url" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(` ${ssrInterpolate(unref(t)("add.url"))}`);
                } else {
                  return [
                    createVNode(_component_UIcon, {
                      name: "i-heroicons-globe-alt",
      ...
      if (unref(activeTab) === "file") {
        ...
        if (unref(isDropzoneSupported)) {
          _push(`<div class="bracket p-8 text-center cursor-pointer transition-colors hover:bg-electric/10"><input type="file" accept=".torrent" class="hidden">`);
          _push(ssrRenderComponent(_component_UIcon, {
            name: "i-heroicons-cloud-arrow-up",
            class: "w-12 h-12 mx-auto text-ghost/50 mb-4"
          }, null, _parent));
          _push(`<p class="text-ghost mb-2 font-bold">${ssrInterpolate(unref(t)("add.dragDrop"))}</p><p class="text-ghost/50 text-sm font-mono">${ssrInterpolate(unref(t)("add.orClickToBrowse"))}</p><span class="bl"></span><span class="br2"></span></div>`);
        } else {
      ...
      if (unref(activeTab) === "magnet") {
        _push(`<div class="space-y-4"><div class="input-bracket">`);
        _push(ssrRenderComponent(_component_UInput, {
        ...
        _push(`<span class="bl"></span><span class="br2"></span></div><div class="flex gap-2">`);
        _push(ssrRenderComponent(_component_UButton, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(` Add magnet <span class="bl"${_scopeId}></span><span class="br2"${_scopeId}></span>`);
            } else {
              return [
      ...
      if (unref(activeTab) === "url") {
        ...
        _push(ssrRenderComponent(_component_UButton, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`${ssrInterpolate(unref(t)("add.addFromUrl"))} <span class="bl"${_scopeId}></span><span class="br2"${_scopeId}></span>`);
            } else {
              return [
...
//# sourceMappingURL=add-DIrxMdKf.mjs.map
