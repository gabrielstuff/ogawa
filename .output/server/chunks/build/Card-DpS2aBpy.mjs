import { e as useLocale, f as useAppConfig, h as useComponentUI, i as usePortal, t as tv, a as _sfc_main$8, d as _sfc_main$d } from './server.mjs';
import { useSlots, toRef, computed, unref, mergeProps, withCtx, toHandlers, renderSlot, createTextVNode, toDisplayString, openBlock, createBlock, createCommentVNode, createVNode, Fragment, defineComponent, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrRenderSlot, ssrInterpolate, ssrRenderClass, ssrRenderAttrs } from 'vue/server-renderer';
import { useForwardPropsEmits, DialogRoot, DialogContent, VisuallyHidden, DialogTitle, DialogDescription, DialogClose, DialogTrigger, DialogPortal, DialogOverlay, Primitive } from 'reka-ui';
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "empty-state bracket-lg" }, _attrs))}>`);
      if (__props.icon) {
      ...
      _push(`<div class="empty-state-title">${ssrInterpolate(__props.title)}</div>`);
      if (__props.subtitle) {
        _push(`<div class="empty-state-sub">${ssrInterpolate(__props.subtitle)}</div>`);
      } else {
        _push(`<!---->`);
      }
...
const __nuxt_component_3 = Object.assign(_sfc_main$2, { __name: "EmptyState" });
...
//# sourceMappingURL=Card-DpS2aBpy.mjs.map
