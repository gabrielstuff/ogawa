import { u as useHead, k as useFetch, h as _sfc_main$8, e as _sfc_main$d, i as useLocale, a as useAppConfig, b as useComponentUI, j as usePortal, t as tv } from './server.mjs';
import { _ as _sfc_main$2 } from './Alert-DHABDpit.mjs';
import { defineComponent, withAsyncContext, ref, mergeProps, withCtx, createTextVNode, unref, toDisplayString, isRef, createVNode, useSlots, toRef, computed, toHandlers, renderSlot, openBlock, createBlock, createCommentVNode, Fragment, useSSRContext } from 'vue';
...
import { _ as _sfc_main$3 } from './Card-BG0rlUjH.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "p-4" }, _attrs))}><div class="flex items-center justify-between mb-6"><h1 class="text-2xl font-bold">RSS Feeds</h1>`);
      ...
      if (!unref(feeds) || unref(feeds).length === 0) {
        ...
        _push(`<p class="text-gray-400 mb-4">No RSS feeds yet</p>`);
        _push(ssrRenderComponent(_component_UButton, {
          onClick: ($event) => showAddModal.value = true
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`Add your first feed`);
            } else {
              return [
                createTextVNode("Add your first feed")
              ];
            }
          }),
          _: 1
        ...
        ssrRenderList(unref(feeds), (feed) => {
          _push(`<div class="bg-gray-800 rounded-lg p-4 flex items-center justify-between"><div class="flex-1 min-w-0"><h3 class="font-medium truncate">${ssrInterpolate(feed.title)}</h3><p class="text-sm text-gray-400 truncate">${ssrInterpolate(feed.url)}</p><div class="flex gap-2 mt-2 text-xs text-gray-500"><span>${ssrInterpolate(feed.items?.length || 0)} items</span><span>Last updated: ${ssrInterpolate(feed.lastUpdated ? new Date(feed.lastUpdated).toLocaleDateString() : "Never")}</span></div></div><div class="flex gap-2 ml-4">`);
          _push(ssrRenderComponent(_component_UButton, {
            variant: "ghost",
            color: "error",
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_UCard, null, {
              header: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<h2 class="text-lg font-bold"${_scopeId2}>Add RSS Feed</h2>`);
                } else {
                  return [
                    createVNode("h2", { class: "text-lg font-bold" }, "Add RSS Feed")
                  ];
                }
              }),
...
//# sourceMappingURL=feeds-G6qrQJ_J.mjs.map
