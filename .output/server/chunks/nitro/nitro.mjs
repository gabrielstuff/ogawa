...
const _jJdhMA = _messagesHandlerCached;

const _lazy_IYr54l = () => import('../routes/api/client/test.mjs');
const _lazy_R4Ddym = () => import('../routes/api/index.mjs');
const _lazy_QGm2YQ = () => import('../routes/api/settings.mjs');
const _lazy__uk3pe = () => import('../routes/api/torrents/_hash_.mjs');
const _lazy_4eb2dt = () => import('../routes/api/index2.mjs');
const _lazy_cZcnMP = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });
